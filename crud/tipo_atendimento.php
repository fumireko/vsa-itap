	...
	<?php if($login === 'admin'): ?>
		<div class="container mt-3">
		  <div class="bg-light rounded pb-3">
			<h1 class="text-center pt-3" id="topo">Lista de tipos de atendimento</h1>
			<p class="text-center">
			<a href="tipo_atendimento/inserir.php" class="col-3 btn btn-sm btn-success">Novo tipo de atendimento</a>
			</p>
			<?php
			  ...
			  <tbody>
				<?php while($row = mysqli_fetch_assoc($result)): ?>
					<tr>
						...
						<a href="tipo_atendimento/editar.php?i=<?= $row['codigo'] ?>" class="col-4 btn btn-sm btn-primary">Editar</a>
						<a href="tipo_atendimento/remover.php?i=<?= $row['codigo'] ?>" class="col-4 btn btn-sm btn-danger">Remover</a>
						</td>
					</tr>
				<?php endWhile; ?>
			  </tbody>
