...
if(isset($_POST['codigo']) && isset($_POST['setor']) && isset($_POST['tipo'])){
	$tipo = $_POST['tipo'];
	$setor = $_POST['setor'];
	$codigo = $_POST['codigo'];
	mysqli_query($conn, "UPDATE tipo_atendimento SET tipo = '$tipo', setor = $setor where codigo = $codigo");
	ob_start();
	...
	<?php if($login === 'admin'): ?>		
		<div class="container mt-3">
		  <div class="bg-light rounded pb-3">
			<h1 class="text-center pt-3" id="topo">Editar tipo de atendimento</h1>
