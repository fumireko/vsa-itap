	...
	<?php if($login === 'admin'): ?>		
		<div class="container mt-3">
		  <div class="bg-light rounded pb-3">
			<h1 class="text-center pt-3" id="topo">Lista de setores</h1>
			<p class="text-center">
			<a href="setor/inserir.php" class="col-3 btn btn-sm btn-success">Novo setor</a>
			</p>
			  ...
			  <tbody>
				<?php while($row = mysqli_fetch_assoc($result)): ?>
					<tr>
						...
						<a href="setor/editar.php?i=<?= $row['codigo'] ?>" class="col-2 btn btn-sm btn-primary">Editar</a>
						<a href="setor/remover.php?i=<?= $row['codigo'] ?>" class="col-2 btn btn-sm btn-danger">Remover</a>
						</td>
					</tr>
				<?php endWhile; ?>
			  </tbody>
